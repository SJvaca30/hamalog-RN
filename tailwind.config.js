  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'button-small': ['14px', { lineHeight: '16.8px' }],
        'button-small-p': ['12px', { lineHeight: '14.4px' }],
        'caption-primary': ['12px', { lineHeight: '14.4px' }],
        'caption-secondary': ['12px', { lineHeight: '14.4px' }],
      },
      letterSpacing: {
        'display-b': '-0.48px',
        display: '-0.44px',
