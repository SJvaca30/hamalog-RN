      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="gap-6 p-4">
          ...
          <Box className="rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 p-6">
            <Text variant="headline-main-b" color="text-gray-0" className="mb-2">
              🎨 Figma Typography 시스템
            </Text>
            <Text variant="body" color="text-gray-0" className="opacity-90">
              Figma에서 가져온 정확한 Typography 스타일로 letter-spacing, font-weight까지 완벽하게
              구현했습니다.
            </Text>
          </Box>
          ...
          <Box className="rounded-xl bg-gray-50 p-6">
            <Text variant="headline-title" color="text-gray-850" className="mb-4">
              📝 Typography Variants
            </Text>
            ...
            <View className="gap-4">
              {/* Headlines */}
              <View>
                <Text variant="button-micro" color="text-gray-500" className="mb-2">
                  HEADLINE 그룹
                </Text>
                ...
                <Text variant="headline-title">Paperlogy Title (18px) - Paperlogy-Medium</Text>
              </View>
              ...
              <View>
                ...
                <Text variant="button-micro">Micro Button (12px) - Paperlogy-Regular</Text>
              </View>
            </View>
          </Box>
          ...
          <Box className="rounded-xl bg-blue-50 p-6">
            <Text variant="headline-title" color="text-primary-700" className="mb-4">
          ...
          <Box className="rounded-xl bg-yellow-50 p-6">
            <Text variant="headline-title" color="text-point-yellow-500" className="mb-4">
            ...
            <View className="gap-4">
              <View>
                ...
                <Text fontFamily="hamalog-bold" hamalogSize="headline-p1" color="text-gray-700">
                  기존 하마로그 폰트 시스템
                </Text>
              </View>
          ...
          <Box className="rounded-xl bg-red-50 p-6">
            <Text variant="headline-title" color="text-point-red-500" className="mb-4">
              ⚠️ 폰트 파일 추가 필요
            </Text>
            <Text variant="body" color="text-point-red-500">
              현재 Pretendard만 로드되어 있습니다. HS유지체와 Paperlogy 폰트 파일을 추가해야 모든
              variants가 정상 작동합니다.
            </Text>
          </Box>
          ...
          <Box className="rounded-xl bg-primary-50 p-6">
            ...
            <Text fontFamily="hamalog" hamalogSize="body-1" color="text-gray-700">
          ...
          <Box className="rounded-xl bg-gray-50 p-6">
            ...
            <View className="gap-3">
              ...
              <Text fontFamily="system" hamalogSize="body-1" color="text-gray-500">
          ...
          <Box className="rounded-xl bg-point-yellow-100 p-6">
            ...
            <View className="gap-4">
              ...
              <View>
                ...
                <Text fontFamily="hamalog-bold" hamalogSize="headline-p1" className="mb-1">
                  P1 요금제 (24px)
                </Text>
                <Text fontFamily="hamalog" hamalogSize="headline-p2" className="mb-1">
                  P2 메인 요금제 (16px)
                </Text>
                <Text fontFamily="hamalog-bold" hamalogSize="headline-main-b" className="mb-1">
                  메인 헤드라인 Bold (24px)
                </Text>
                <Text fontFamily="hamalog" hamalogSize="headline-main-l" className="mb-1">
                  메인 헤드라인 Light (22px)
                </Text>
              ...
              <View>
                ...
                <Text fontFamily="hamalog" hamalogSize="body-1" className="mb-1">
                  Body1 일반 본문 (16px)
                </Text>
                <Text fontFamily="hamalog" hamalogSize="body-2" className="mb-1">
                  Body2 보조 설명 (14px)
                </Text>
                <Text fontFamily="hamalog-bold" hamalogSize="caption-b" className="mb-1">
                  Caption Bold (12px)
                </Text>
              ...
              <View>
                ...
                <Text fontFamily="hamalog-semibold" hamalogSize="button-primary" className="mb-1">
                  Primary Button (16px)
                </Text>
                <Text fontFamily="hamalog" hamalogSize="button-date" className="mb-1">
                  Date 텍스트 (14px)
                </Text>
                <Text fontFamily="hamalog-medium" hamalogSize="button-secondary" className="mb-1">
          ...
          <Box className="rounded-xl bg-primary-100 p-6">
            ...
            <View className="gap-4">
              <View className="rounded-lg bg-gray-0 p-4">
                ...
                <Text fontFamily="system" hamalogSize="caption" color="text-gray-700">
          ...
          <Box className="rounded-xl bg-gray-100 p-6">
            ...
            <View className="gap-3">
              <Text fontFamily="hamalog" hamalogSize="body-1" color="text-primary-700">
                Primary Blue 텍스트
              </Text>
              <Text fontFamily="hamalog-bold" hamalogSize="body-1" color="text-point-red-500">
                Point Red Bold 텍스트
              </Text>
              <Text fontFamily="hamalog-medium" hamalogSize="body-1" color="text-point-yellow-500">
                Point Yellow Medium 텍스트
              </Text>
              <Text fontFamily="hamalog" hamalogSize="body-2" color="text-gray-500">
                Gray Small 텍스트
              </Text>
            </View>
          </Box>
          ...
          <Box className="rounded-xl bg-point-red-100 p-6">
            ...
            <Text fontFamily="hamalog" hamalogSize="body-2" color="text-gray-700" className="mb-3">
              현재 시스템 폰트를 사용 중입니다. 커스텀 폰트를 적용하려면:
            </Text>
            <View className="gap-2">
              <Text fontFamily="hamalog" hamalogSize="caption" color="text-gray-700">
